...
#Capture one frame by pressing c
#Detect maze boundary by finding corners
#Expands the corners
#Save outputs: raw camera frame, overlay image, JSON with corner coordinates
"""
...
#takes 4 corner points and forces them into an order
...
#find maze boundary, converts the contour into a 4 corner shape
...
#detected corners may land slightly inside the maze border so expanding helps include the full maze
...
#makes the visual image with corners with green dots and labels
